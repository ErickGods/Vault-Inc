...
O **ROE** (`Lucro Líquido / PL médio`) mede o retorno ao acionista e incorpora a alavancagem: o
mesmo negócio com mais dívida exibe ROE maior sem ter melhorado em nada. O **ROIC**
(`EBIT×(1−T) / Capital Investido`) mede o retorno do negócio independentemente de como ele foi
financiado — e comparado ao WACC é o teste real de criação de valor.

As duas fórmulas com o capital investido definido linha a linha, a decomposição DuPont de 3 e 5
fatores, o comparativo ROIC vs WACC e as armadilhas (PL negativo, goodwill de aquisição inflando o
denominador, distorção do JCP, um ano não é sinal) estão em [[roe-roic]]. O exemplo numérico fechado
de DuPont permanece abaixo, em *How to Apply*.
...
- [[roe-roic]] — Aprofundamento em ROE, ROIC, DuPont e o teste ROIC vs WACC
