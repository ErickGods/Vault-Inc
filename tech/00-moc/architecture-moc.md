...
|---------|---------|--------|
| [[adr-guide]] | Template e processo para ADRs | ✅ active |
...
- [[adr-guide]] — Documentar decisões arquiteturais
...
Template em [[adr-guide]]. Armazenar ADRs no repositório junto ao código (`docs/adr/`).
